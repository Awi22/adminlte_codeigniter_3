...
<head>
    ...
    <script nonce="086da4cf-79ce-4842-a48e-f732bd6cb4bf">
        (function(w, d) {
            ! function(Z, _, ba, bb) {
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url(); ?>dashboard2" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v2</p>
                                    </a>
                                </li>
                    ...
                    <div class="row">
                            ...
                            <div class="card card-widget widget-user-2">
                                ...
                                <div class="widget-user-header bg-warning">
                                    <div class="widget-user-image">
                                        <img class="img-circle elevation-2" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user7-128x128.jpg" alt="User Avatar">
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle elevation-2" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user1-128x128.jpg" alt="User Avatar">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user">
                                ...
                                <div class="widget-user-header text-white" style="background: url('<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/photo1.png') center center;">
                                    <h3 class="widget-user-username text-right">Elizabeth Pierce</h3>
                                    <h5 class="widget-user-desc text-right">Web Designer</h5>
                                </div>
                                <div class="widget-user-image">
                                    <img class="img-circle" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user3-128x128.jpg" alt="User Avatar">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-right">
                            ...
                            <div class="card card-widget">
                                <div class="card-header">
                                    <div class="user-block">
                                        <img class="img-circle" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user1-128x128.jpg" alt="User Image">
                                ...
                                <div class="card-body">
                                    <img class="img-fluid pad" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/photo2.png" alt="Photo">
                                ...
                                <div class="card-footer card-comments">
                                    <div class="card-comment">
                                        ...
                                        <img class="img-circle img-sm" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user3-128x128.jpg" alt="User Image">
                                    ...
                                    <div class="card-comment">
                                        ...
                                        <img class="img-circle img-sm" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user4-128x128.jpg" alt="User Image">
                                        <div class="comment-text">
                                            <span class="username">
                                                Luna Stark
                                                <span class="text-muted float-right">8:03 PM Today</span>
                                ...
                                <div class="card-footer">
                                    <form action="#" method="post">
                                        <img class="img-fluid img-circle img-sm" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user4-128x128.jpg" alt="Alt Text">
                            ...
                            <div class="card card-widget">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="attachment-block clearfix">
                                        <img class="attachment-img" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/photo1.png" alt="Attachment Image">
                                ...
                                <div class="card-footer card-comments">
                                    ...
                                    <div class="card-comment">
                                        ...
                                        <img class="img-circle img-sm" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/user5-128x128.jpg" alt="User Image">
                                        <div class="comment-text">
                                            <span class="username">
                                                Nora Havisham
                                                <span class="text-muted float-right">8:03 PM Today</span>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-6 col-xl-4">
                                    <div class="card mb-2 bg-gradient-dark">
                                        <img class="card-img-top" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/photo1.png" alt="Dist Photo 1">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-4">
                                    <div class="card mb-2">
                                        <img class="card-img-top" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/photo2.png" alt="Dist Photo 2">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-4">
                                    <div class="card mb-2">
                                        <img class="card-img-top" src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.2.0/dist/img/photo3.jpg" alt="Dist Photo 3">
